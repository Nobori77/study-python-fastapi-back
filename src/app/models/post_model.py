...
class Post(Base):
    ...
    post_create_at: Mapped[datetime] = mapped_column(DateTime, default=lambda: datetime.now(KST))
    post_update_at: Mapped[datetime] = mapped_column(DateTime, default=lambda: datetime.now(KST))
